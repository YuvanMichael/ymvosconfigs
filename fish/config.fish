...
set VISUAL "nvim"              # $VISUAL use neovim in GUI mode (not sure if it has one.)
...
# startup
alias startup="ffplay -nodisp -autoexit ~/startupsound.mp3"

# Terminal Shananigans and Tomfoolery in the terminal
alias bs="./bs.sh"
...
# wallpapers
alias feh="feh --randomize --bg-fill /usr/share/backgrounds/dtos-backgrounds/*"
...
### SETTING THE STARSHIP PROMPT AND STARTUP ITEMS ###
neofetch
echo 'Weeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee!'
